...
card_topic_1 = st.text_input("Topic 1")
card_topic_2 = st.text_input("Topic 2")
card_topic_3 = st.text_input("Topic 3")
card_topic_4 = st.text_input("Topic 4")
card_topic_5 = st.text_input("Topic 5")
card_topic_6 = st.text_input("Topic 6")

# prompt the user to enter the questions for the side-bar
st.markdown("Enter the topics for the side-bar below")
sidebar_topic_1 = st.text_input("Sidebar Topic 1")
sidebar_topic_2 = st.text_input("Sidebar Topic 2")
sidebar_topic_3 = st.text_input("Sidebar Topic 3")
sidebar_topic_4 = st.text_input("Sidebar Topic 4")
sidebar_topic_5 = st.text_input("Sidebar Topic 5")
sidebar_topic_6 = st.text_input("Sidebar Topic 6")
